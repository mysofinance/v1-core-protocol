...
```solidity
function isApproved(address _ownerOrBeneficiary, address _sender, enum IBasePool_v_1_1.ApprovalTypes _approvalType) external view returns (bool _approved)
```
...
| \_approvalType       | enum IBasePool_v_1_1.ApprovalTypes | Type of approval requested { REPAY, ADD_LIQUIDITY, REMOVE_LIQUIDITY, CLAIM } |
